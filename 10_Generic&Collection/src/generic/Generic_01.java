 ...
 *       번거로운 형변환 작업을 줄여 준다는 장점이 있음.
 *       또한 객체의 타입을 컴파일 시에 체크하여 주기 때문에
 *       객체의 타입 안정성을 높여주는 장점도 있음.
 * - 여기서의 타입의 안정성을 높여 준다는 것은 의도하지 않은 타입의
...
public class Generic_01 {
	...
	public static void main(String[] args) {
		...
		box.setObj("제네릭"); // 오브젝트 타입이라 모든 자료형이 들어감.

		/*
		 * Object 타입으로 선언된 변수에 데이터가 들거나는 경우 반드시 형변환을 해 주어야 함. 이러한 형변환 작업이 자주 일어나게 되면
		 * 프로그램 성능이 저하가 된다.
		 */
