...
public class List_04 {
	...
	public static void main(String[] args) {
		...
		// 1.키보드로 회원의 수만큼 회원 정보를 입력 받아서 ArrayList에 저장해 보자.

		for (int i = 0; i < memberCount; i++) {

			System.out.println((i + 1) + "번째 회원의 아이디, 비밀번호, 이름, 나이, 연락처, 주소를 입력하세요.");

			Member member = new Member(sc.next(), sc.next(), sc.next(), sc.nextInt(),
					sc.next(), sc.next());

			list.add(member); // 참조변수를 넣어주니까 주소값을 넣어주는거임!
			// ★★★★★★★★★★★★★★★★★★★★★ 잘알두기. 객체배열이랑 비슷함. 아주 중요함
