 ...
 * - 인터페이스를 통해서 정형화된 방법으로 다양한 컬렉션 클래스를 
 *   이용.
 * 
 * - 컬렉션 프레임워크
 ...
 *      ==> ArrayList(O), LinkedList(가끔), Vector(X) //벡터는 요새 잘 안써줌 
 *    - 특히 DB에 데이터를 레코드 단위로 저장하거나
 *      저장된 데이터를 가져을 경우 많이 사용이 됨.
 * ★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★    
 * 
 *ArrayList는 첨에 자동으로 10개의 공간을 잡아주고 필요시 자동으로 10개를 더 추가 해줌.
 */
...
public class List_01 {
	...
	public static void main(String[] args) {
		...
		// 제네릭...
		// 부모의 참조변수로 자식의 .... 다형성...
		// 원래는 ArrayList<String> list = new ArrayList<String>(); // 부모의 참조변수로 자식의 ....
		// 다형성...
		...
		// 3.get (index)
		// ==>ArrList에 저장되어 있는 데이터를 출력해 주는 메서드.

		System.out.println("list[2] 데이터 " + list.get(2));

		// ArrayList에 있는 모든 데이터를 화면에 출력해 보자
		for (int i = 0; i < list.size(); i++) { // 문제에서 length를 써주면 틀림!
		...
		// 4.clear()
		// ==> ArrayList에 들어 있는 모든 데이터를 제거하는 메서드
		...
		// 해당 index에 추가가 되고, 기존에 있던 데이터들은 index가 뒤로 하나씩 밀려난다.
